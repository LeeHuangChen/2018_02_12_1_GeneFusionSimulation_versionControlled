...
def main():
	...
	total=len(conf.models)*len(conf.seqLens)*len(conf.numFamilies)*len(conf.numFusionEvents)*len(conf.totalEvolutionTimes)*len(conf.numGenerations)
				...
				for numFusionEvent in conf.numFusionEvents:
					for totalEvolutionTime in conf.totalEvolutionTimes:
						for numGeneration in conf.numGenerations:
							testName=fio.name(model,seqLen,numFamily, numFusionEvent,totalEvolutionTime, numGeneration)
							print "\n============================="
							...
							fusedFamilies.main(model,seqLen,numFamily, numFusionEvent,totalEvolutionTime, numGeneration)
