...
def FindSequencesByGeneration(familyPath, famID, genID):
	...
	if curdir==familyPath:
		sys.exit("FindSequencesByGeneration("+familyPath+", "+famID+", "+genID+"). Failed!\nCurdir="+curdir)
	genPath=curdir
...
def GenerateFusedGeneFamilies(famPath, fusedPath, model, numFusionEvents, seqLen, numFamilies, numGenerations, TotalEvolutionTime):
	#directories
...
def main(model, seqLen, numFamilies, numFusionEvents, TotalEvolutionTime, numGenerations):
	...
	GenerateFusedGeneFamilies(famPath, fusedPath, model, numFusionEvents, seqLen, numFamilies, numGenerations, TotalEvolutionTime)
